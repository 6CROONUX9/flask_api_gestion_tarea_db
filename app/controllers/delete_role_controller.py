...
# Este controlador maneja las operaciones CRUD para los roles. Los roles se utilizan para definir
# los permisos que los usuarios tienen dentro del sistema, como la capacidad de crear, modificar o eliminar tareas.
# En caso de que sea necesario, se puede extender este controlador para incluir permisos específicos por rol 
# para las operaciones sobre las tareas.